...
export default function AdminEditCollectionPage() {
  const { collections, products, updateCollection } = useAdmin()
      ...
      <AdminLayout>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-8">
          <div className="flex items-center gap-4 mb-8">
            ...
            <h1 className="text-2xl font-semibold text-gray-900">Colección no encontrada</h1>
          </div>
          <p className="text-gray-500">La colección que intentas editar no existe.</p>
        </div>
      </AdminLayout>
    )
  }
    ...
    <AdminLayout>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-8">
        <div className="flex items-center gap-4 mb-8">
          ...
          <h1 className="text-2xl font-semibold text-gray-900">Editar colección</h1>
        </div>
